...
class Tektronix_DPO4034_Oscope(VISAInstrumentDriver, Configurable):
    ...
    def __init__(self, name='The slow oscilloscope', address=None, **kwargs):
        ...
        self.dpo = True
        # super().__init__('The slow oscilloscope', 'visa://' + hostNS[hostname] + '/USB0::0x0699::0x0401::B020016::INSTR', tempSess=True)
        self.totalChans = 4
