...
class Tektronix_TDS6154C_Oscope(VISAInstrumentDriver, Configurable):
    ...
    '''
    # def __init__(self, isDPO=False, hostname='corinna'):
    def __init__(self, name='The fast oscilloscope', address=None, **kwargs):
        VISAInstrumentDriver.__init__(self, name=name, address=address, **kwargs)
        self.dpo = False
        # s = 'visa://' + hostNS[hostname] + '/GPIB' + str(1) + '::' + str(1) + '::INSTR'
        # super().__init__('The fast oscilliscope', s, tempSess=True)
        self.totalChans = 4
