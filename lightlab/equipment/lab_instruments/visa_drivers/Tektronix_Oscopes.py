...
from lightlab.equipment.abstract_drivers import Tek_TDS, Tek_DSA, Tek_DPO

class Tektronix_TDS6154C_Oscope(VISAInstrumentDriver, Tek_TDS):
...
class Tektronix_CSA8000_CAS(VISAInstrumentDriver, Tek_DSA):
...
class Tektronix_DSA8300_Oscope(VISAInstrumentDriver, Tek_DSA):
    ''' See abstract driver for description
...
class Tektronix_DPO4032_Oscope(VISAInstrumentDriver, Tek_DPO):
    ''' See abstract driver for description
...
class Tektronix_DPO4034_Oscope(VISAInstrumentDriver, Tek_DPO):
    ''' See abstract driver for description
