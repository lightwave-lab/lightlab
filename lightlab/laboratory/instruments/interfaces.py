...
class PowerMeter(Instrument):
    ...
    essentialMethods = Instrument.essentialMethods + ["powerDbm", "powerLin"]
...
class Clock(Instrument):
    ...
    essentialMethods = Instrument.essentialMethods + ["enable", "frequency"]
...
class FunctionGenerator(Instrument):
    ...
    optionalAttributes = Instrument.optionalAttributes + ["setArbitraryWaveform"]
...
class OpticalSpectrumAnalyzer(Instrument):
    ...
    essentialMethods = Instrument.essentialMethods + ["spectrum"]
    essentialProperties = Instrument.essentialProperties + ["wlRange"]
...
class Oscilloscope(Instrument):
    ...
    essentialMethods = Instrument.essentialMethods + ["acquire", "wfmDb", "run"]
    optionalAttributes = Instrument.optionalAttributes + ["histogramStats"]
...
class DSAOscilloscope(Oscilloscope):
    ...
    essentialMethods = Oscilloscope.essentialMethods + ["histogramStats"]
...
class VariableAttenuator(Instrument):
    ...
    essentialMethods = Instrument.essentialMethods + ["on", "off"]
    essentialProperties = Instrument.essentialProperties + [
        "attenDB",
        "attenLin",
        "wavelength",
...
class ArduinoInstrument(Instrument):
    ...
    essentialMethods = Instrument.essentialMethods + ["write", "query"]
